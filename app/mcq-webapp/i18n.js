(() => {
  ...
  const translations = new Map(Object.entries({
    ...
    "CAS式形式では、問題文用の変数に代入する式を入力します。sconcatなどで問題文を表す文字列を返す式を書いてください。変数名や代入記号は不要です。": "In CAS mode, enter the expression assigned to the question-text variable. Use an expression returning the question text, such as sconcat. Do not include a variable name or assignment operator.",
