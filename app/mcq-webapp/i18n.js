(() => {
  ...
  const translations = new Map(Object.entries({
    ...
    "依頼をコピーまたは保存してAIへ渡し、作成されたJSONファイルをダウンロードして「翻訳JSONを読込」で反映します。1言語ずつ繰り返してください。ファイル作成に対応したAIが必要です。": "Copy or save the request for your AI, download its JSON file, then use Load translation JSON to apply it. Repeat for each language. Your AI must support downloadable file creation.",
