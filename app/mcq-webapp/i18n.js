(() => {
  ...
  const translations = new Map(Object.entries({
    ...
    "Moodle/STACKから取得できるURLを指定します。include URLベースには公開先の基準URLを入力してください。": "Specify a URL accessible to Moodle/STACK. Enter the base URL of the hosting location in Include URL base.",
    "XMLとincludeファイルは別々に保存します。「include保存」で取得したファイルを、XMLのstack_includeに記載されたURLで取得できる場所へ配置してください。保存操作だけでは公開先へアップロードされません。": "Save the XML and include file separately. Place the file obtained with Save include at the URL referenced by stack_include in the XML. Saving does not upload it to the hosting location.",
    "見本": "Samples",
    "読み込み": "Load",
    "表示": "View",
    "保存": "Save",
