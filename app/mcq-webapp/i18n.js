(() => {
  ...
  const translations = new Map(Object.entries({
    ...
    "このパターンは正解・不正解別": "Separate correct/incorrect feedback for this pattern",
    "選択肢データ": "Option data",
    "行追加": "Add row",
    "クリア": "Clear",
    "パターン": "Pattern",
    ...
    "正解・不正解を入れ替え": "Swap correct/incorrect",
    "全体の正解・不正解を入れ替え": "Swap all correct/incorrect options",
    "このパターンの全言語の選択肢とフィードバックを入れ替えます": "Swap this pattern’s options and feedback in all languages",
    "全パターンの全言語の選択肢とフィードバックを入れ替えます": "Swap options and feedback for all patterns in all languages",
