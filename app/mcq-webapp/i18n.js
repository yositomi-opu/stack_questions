(() => {
  ...
  const translations = new Map(Object.entries({
    ...
    "「問題変数を評価」で現在の設定を使って計算し、右側の評価結果に変数の値やリストの長さを表示します。設定を変更したら再評価してください。": "Evaluate question variables uses the current settings and shows variable values and list lengths in the results on the right. Evaluate again after changing settings.",
